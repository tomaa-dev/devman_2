...
of fame once in a lifetime and I guess that this is mine. People have also told me to make these next few minutes 
...
''', 'ru'))
print('78 - ' + translit(num2words(78), 'ru'), '15 - ' + translit(num2words(15), 'ru'),
'3 - ' + translit(num2words(3), 'ru'), '40 - ' + translit(num2words(40), 'ru'), '8 - ' + translit(num2words(8), 'ru'), sep = '\n')